...
class TestKauppa(unittest.TestCase):
    ...
    def test_koriin_lisataan_kaksi_eri_tuotetta_ja_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_koriin_lisataan_kaksi_samaa_tuotetta_ja_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_koriin_lisataan_varastossa_oleva_tuote_ja_varastosta_puuttuva_tuote(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
